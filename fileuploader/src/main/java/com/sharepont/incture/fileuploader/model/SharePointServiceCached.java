...
public class SharePointServiceCached {
	...
	@Autowired
	private SharePointPropertiesDto sharePointProperties;
	...
	public String receiveSecurityToken(Long executionDateTime) throws Exception {
		RequestEntity<String> requestEntity = new RequestEntity<String>(buildSecurityTokenRequestEnvelope(),
				HttpMethod.POST, new URI(sharePointProperties.getEndpointToken() + "/extSTS.srf"));
	...
	private String buildSecurityTokenRequestEnvelope() {
		System.err.println("SharePoint Properties, userName: " + sharePointProperties.getUsername() + ", password: "
				+ sharePointProperties.getPassword() + ", Endpoint Token: " + sharePointProperties.getEndpointToken()
				+ ", Endpoint Domain: " + sharePointProperties.getEndpointDomain());
	...
	public List<String> getSignInCookies(String securityToken) throws Exception {
		RequestEntity<String> requestEntity = new RequestEntity<String>(securityToken, HttpMethod.POST,
				new URI("https://incturet.sharepoint.com" // +
	...
	public String getFormDigestValue(List<String> cookies)
		...
		RequestEntity<String> requestEntity = new RequestEntity<String>(headers, HttpMethod.POST,
